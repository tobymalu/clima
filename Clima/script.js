function consultarClima(){
    ...
    .then(data=>{
       ...
       let hora= new Date(data.dt*1000).toLocaleString("es-MX",{
        timeStyle:"short"
       });
       fila.insertCell().innerHTML=hora;
       fila.insertCell().innerHTML=`<img src=https://openweathermap.org/img/wn/${icono}@2x.png  alt="">`;
...
function consultarClimas(){
    ...
    .then(data=>{
        ...
        data.forEach(ciudad=>{
            ...
            fila.insertCell().innerHTML=`<img src=https://openweathermap.org/img/wn/${iconos}@2x.png  alt="">`;
